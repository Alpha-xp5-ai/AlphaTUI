...
/* BIOS-dependent macros (stubbed on non-DOS platforms) */
#ifndef _MSC_VER
    #define SCREENWIDTH   (80)     /* fallback */
    #define SCREENHEIGHT  (25)     /* fallback */
    #define clearBIOSbuffer() ((void)0)
    #define waitforkeyboard() ((void)0)
#else
    ...
    #define waitforkeyboard() while ((keyportvalue & 0x80) == 0) clearBIOSbuffer()
#endif
...
#define set_timer(timer, s)   (timer=(s)*182/10+1)
...
/* ====== Compatibility Macros (stubs on Linux) ====== */
#if defined(MSC) || defined(WATCOM)
    #define asm __asm
    #undef FP_OFF
    #undef FP_SEG
    ...
    #define MAXEXT       5
#else
    /* Stub versions for Linux */
    #define poke(a,b,c)   ((void)0)
    #define pokeb(a,b,c)  ((void)0)
    #define peek(a,b)     (0)
    #define peekb(a,b)    (0)
#endif

/* ====== Message and Class Enums ====== */
typedef enum messages {
    #define DFlatMsg(m) MSG_##m,
    #include "dflatmsg.h"
    MESSAGECOUNT
} MESSAGE;

typedef enum window_class {
    #define ClassDef(c,b,p,a) CLS_##c,
    #include "classes.h"
    CLASSCOUNT
} CLASS;
